...
Backup: `src/core/backup.ts` + `backup-actions` — xuất/nhập JSON (`appState` + pools); âm thanh tùy chỉnh không đưa vào file backup.
...
**Android hiện tại:** `versionName` **1.1** / `versionCode` **2** — chi tiết từng bản trong [`releases/LICH-SU-PHIEN-BAN.md`](releases/LICH-SU-PHIEN-BAN.md)
